...
- [Enable Ingestion from Reddit and Steam](#enable-ingestion from-reddit-and-steam)
...
### Enable Ingestion from Reddit and Steam

To enable ingestion from Reddit and Steam, you'll need to provide API keys to authenticate API calls.

#### 1. Add Secrets

- Option 1: [Databricks Notebook](https://docs.databricks.com/aws/en/notebooks/)
      ...
      resources:
        ...
        - name: steam_api_key
          secret:
            ...
            key: steam_api_key
```
#### 3. Redeploy DAB and App with new configuration

_Only required if you have already deployed the DAB and App._

- Option 1: If you deployed via `Demo_Setup.ipynb`, rerun the notebook with the same parameters

- Option 2: If you deployed via the [Databricks CLI](https://docs.databricks.com/aws/en/dev-tools/cli/), execute the following commands in the CLI:
  ...
  # redeploy app with new config
  databricks bundle run  games_social_listening_app
  ```
